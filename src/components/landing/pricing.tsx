 ...
 * column is flagged with a plain mono label and carries the solid CTA.
 */
        ...
        <div className="mt-14 grid lg:grid-cols-2 lg:divide-x lg:divide-zinc-200">
          {plans.map((plan) => (
            ...
            >
              ...
              <Link
                href="/signup"
                className={`mt-9 inline-flex w-full items-center justify-center gap-2 px-6 py-3.5 text-sm font-medium transition-colors duration-150 ease-out sm:w-auto ${
                  plan.popular
